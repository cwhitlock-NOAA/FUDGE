...
#------------ historical predictor(s)----------# 
	...
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING/GCM_DATA/NCPP/GFDL-HIRAM-C360-COARSENED/amip/day/atmos/day/r1i1p1/v20110601' 
	hist.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_19790101-20081231.nc' 
#------------ future predictor(s) -------------# 
	fut.file.start.year_1 <- 19790101 
	fut.file.end.year_1 <- 20081231 
        fut.train.start.year_1 <- 19790101 
        fut.train.end.year_1 <- 20081231 
	fut.scenario_1 <- 'amip_r2i1p1'
	fut.nyrtot_1 <- (fut.train.end.year_1 - fut.train.start.year_1) + 1
	fut.model_1 <- 'GFDL-HIRAM-C360-COARSENED' 
	fut.freq_1 <- 'day' 
	fut.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING/GCM_DATA/NCPP/GFDL-HIRAM-C360-COARSENED/amip/day/atmos/day/r2i1p1/v20110601'
	fut.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_bymonth_19790101-20081231.nc'
