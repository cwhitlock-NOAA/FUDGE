...
ds.method <- 'CDFt' 
ds.experiment <- 'RRprp1-CDFt-B38apL01K00' 
k.fold <- 0 
...
mask.output.dir <- '/archive/esd/PROJECTS/DOWNSCALING/RR/downscaled/NOAA-GFDL/MPI-ESM-LR/rcp85/day/atmos/day/r1i1p1/v20111014/RRprp1-CDFt-B38apL01K00/pr/RR/OneD/v20140108//pr_qcmask/' 
#-------------  custom -----------------------#
