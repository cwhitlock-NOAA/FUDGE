...
#------------ historical predictor(s)----------# 
	...
	hist.model_1 <- 'MIROC5' 
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///GCM_DATA/CMIP5//MIROC5/historical//atmos/day/r1i1p1/v20120710/tasmin/SCCSC0p1/OneD/' 
	hist.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_byseason_19610101-20051231.NOLEAP.nc' 
#------------ future predictor(s) -------------# 
	fut.file.start.year_1 <- 2006 
	fut.file.end.year_1 <- 2099 
        fut.train.start.year_1 <- 2006 
        fut.train.end.year_1 <- 2099 
	fut.scenario_1 <- 'rcp26_r2i1p1'
	fut.nyrtot_1 <- (fut.train.end.year_1 - fut.train.start.year_1) + 1
	fut.model_1 <- 'MIROC5' 
	fut.freq_1 <- 'day' 
	fut.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///GCM_DATA/CMIP5//MIROC5/rcp26//atmos/day/r2i1p1/v20120710/tasmin/SCCSC0p1/OneD/'
	fut.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_byseason_20060101-20991231.NOLEAP.nc'
...
#------------- target -------------------------# 
	...
	target.freq_1 <- 'day' 
        target.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING///OBS_DATA/GRIDDED_OBS//livneh/historical//atmos/day/r0i0p1/v1p2/tasmin/SCCSC0p1/OneD/'
	target.time.window <- '/archive/esd/PROJECTS/DOWNSCALING/3ToThe5th/masks/timemasks/maskdays_byseason_19610101-20051231.NOLEAP.nc'
#------------- method name k-fold specs-----------------------#
        ds.method <- 'BCQM' 
	ds.experiment <- 'RRtnp1-BCQM-A22aqL01K00' 
	k.fold <- 0 
	
#-------------- output -----------------------#
	output.dir <- '/home/cew/Code/testing/reg_tests/'
	mask.output.dir <- '/home/cew/Code/testing/reg_tests/' 
#-------------  custom -----------------------#
        args=list('na') 
...
#	FUDGEROOT = Sys.getenv(c("FUDGEROOT"))
	FUDGEROOT <- '/home/esd/local/opt/fudge//cinnamon/fudge2014/'
