...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'CDFt' 
	ds.experiment <- 'RRtxp1-CDFt-A38af-mL01K00' 
	k.fold <- 0 
#pr_opts=list(opt_wetday='zero',lopt_drizzle='on',lopt_conserve='off')
pr_opts <- list(pr_threshold_in='us_trace', freq_adj_in='off', pr_conserve_in='on', 
                pr_threshold_out='zero', pr_conserve_out='on')
#-------------- output -----------------------#
