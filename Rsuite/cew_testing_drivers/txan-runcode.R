...
#------------ historical predictor(s)----------# 
	...
	hist.freq_1 <- 'day' 
	hist.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING/GCM_DATA/NCPP/GFDL-HIRAM-C360-COARSENED/amip/day/atmos/PManom1979-2008Sbx7/r1i1p1/v20110601' 
...
#------------ future predictor(s) -------------# 
	...
	fut.freq_1 <- 'day' 
	fut.indir_1 <- '/archive/esd/PROJECTS/DOWNSCALING/GCM_DATA/NCPP/GFDL-HIRAM-C360-COARSENED/sst2090/day/atmos/PManom2086-2095Sbx7/r1i1p1/v20110601'
...
#------------- target -------------------------# 
	...
	target.freq_1 <- 'day' 
        target.indir_1 <- paste0('/archive/esd/PROJECTS/DOWNSCALING/GCM_DATA/NCPP/GFDL-HIRAM-C360/amip/day/atmos/PManom1979-2008Sbx7/r1i1p1/v20110601/', 
...
#------------- method name k-fold specs-----------------------#
        ds.method <- 'BCQM' 
	ds.experiment <- 'PMtxanp1-BCQM-A01r11TEST1X01K00' 
	k.fold <- 0 
